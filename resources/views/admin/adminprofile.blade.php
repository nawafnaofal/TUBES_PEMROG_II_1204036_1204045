...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <a href="{{ url('dashboard') }}" class="btn btn-info"><i class="fa fa-arrow-left"></i> Kembali</a>
        </div>
                ...
                <div class="card mb-3">
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ url('editprofile') }}">
                            ...
                            <div class="form-group row">
                                <label for="alamat" class="col-md-2 col-form-label text-md-right">Rekening</label>

                                <div class="col-md-6">
                                    <input type="number" name="rekening" class="form-control @error('rekening') is-invalid @enderror" required="" value="{{ $user->rekening }}"></input>
