            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{ url('historipesanan') }}">Histori Pesanan</a>
                    </div>
                </div>
            </li>
            <li class="nav-item">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Data Histori Pesanan</h1>
                    </div>
                                        ...
                                        <table class="table table-striped" id="dataTable" width="100%" cellspacing="0">
                                            ...
                                            <tbody align="center">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if($p->status == 3)
                                                        <div class="badge bg-success text-white"><i class="fas fa-check"></i></div>
                                                        @elseif($p->status == 4)
                                                        <div class="badge bg-danger text-white"><i class="fas fa-window-close mr-2"></i>Dibatalkan admin karena {{$p->keterangan}}</div>
                                                        @endif
                                                    </td>
                                                    <td>
                                                        <a href="{{ url('detailpesanan', $p->pesanan_id) }}" class="btn btn-info position-relative">
                                                            <i class="fas fa-eye"></i>
                                                            @if(empty($p->penerima)&& $p->status ==3)
