                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-2">
                            <div class="card">
                                <div class="card-body">
                                    <h5><i class="fas fa-plus-square mr-3"></i> Tambah Data Kategori Barang</h5>
                                    <form action="{{ url('simpankategori')}}" method="post" onsubmit="return kategori();">
                                        {{ csrf_field() }}
                                        <div class="input-group mt-3">
                                            <input name="nama" class="form-control text-black" id="kategori" type="text" placeholder="Masukkan nama kategori" aria-label="default input example">
                    ...
                    <script>
                        ...
                        function kategori() {
                            ...
                            if (stringContainsNumber(kategori)) {
                                console.log("Jalan false")
                                swal("Ups", "Harap masukkan nama kategori dengan benar!", 'warning');
                                return false;
                    ...
                    <!-- akhir validasi tambah kategori -->
                </div>
            </div>
